...
col_names = [
    "noise_perc_th", "noise_perc", "SNR_dB", "Param_f1","Param_f2","Param_f1_ridge","Param_f2_ridge","Param_f1_STLSQ","Param_f2_STLSQ","Param_f1_huber","Param_f2_huber","Param_f1_affineOLS","Param_f2_affineOLS", 
]
...
# FIGURE 1: f1
# =============================================================================
plot1_cols = ['Param_f1','Param_f1_ridge','Param_f1_STLSQ','Param_f1_huber','Param_f1_affineOLS']#'SR_f1','LS_f1','SINDy_f1']
# Create a dictionary to map column names to desired labels
label_map = {
    'Param_f1': 'Parametric OLS',
    'Param_f1_ridge': 'Parametric Ridge',
    'Param_f1_STLSQ': 'Parametric STLSQ',
    'Param_f1_huber': 'Parametric Huber',
    'Param_f1_affineOLS': 'Parametric Affine OLS',
#    'SINDy_f1': 'SINDy-CC',
#    'LS_f1': 'LS-CC',
#    'SR_f1': 'SR'
}
...
plt.tight_layout()
plt.savefig("rmse_f1_with_and_without_symm.pdf")
...
plot2_cols = ['Param_f2','Param_f2_ridge','Param_f2_STLSQ','Param_f2_huber','Param_f2_affineOLS']#'SR_f1','LS_f1','SINDy_f1']
# Create a dictionary to map column names to desired labels
label_map_f2 = {
    'Param_f2': 'Parametric OLS',
    'Param_f2_ridge': 'Parametric Ridge',
    'Param_f2_STLSQ': 'Parametric STLSQ',
    'Param_f2_huber': 'Parametric Huber',
    'Param_f2_affineOLS': 'Parametric Affine OLS',
#    'SINDy_f1': 'SINDy-CC',
#    'LS_f1': 'LS-CC',
#    'SR_f1': 'SR'
}
...
plt.tight_layout()
plt.savefig("rmse_f2_with_and_without_symm.pdf")
plt.show()
