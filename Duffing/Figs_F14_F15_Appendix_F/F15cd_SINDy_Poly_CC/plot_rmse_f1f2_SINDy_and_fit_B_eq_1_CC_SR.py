...
col_names = [
    "noise_perc_th", "noise_perc", "SNR_dB","SINDy_f1_ku0","SINDy_f2_ku0", "SINDy_f1","SINDy_f2", "SINDy_f1_sym","SINDy_f2_sym","SINDy_f1_sym_SR","SINDy_f2_sym_SR","Poly_f1","Poly_f2","Param_f1","Param_f2"
]
...
# PLOT 1: F1
# =========================================================
#plot1_cols = ['Param_f1', 'SINDy_f1_ku0','Poly_f1','SINDy_f1']
plot1_cols = ['Param_f1', 'SINDy_f1_sym','Poly_f1','SINDy_f1', 'SINDy_f1_sym_SR']

label_map_f1 = {
    'Param_f1': 'Parametric',
    'Poly_f1': 'Poly-CC',
    'SINDy_f1': 'SINDy-CC',
#    'SINDy_f1_ku0': 'SINDy-CC ku0',
    'SINDy_f1_sym': r'SINDy-CC$_{+sym}$',
    'SINDy_f1_sym_SR': r'SINDy-CC$_{+sym+post\!\!-\!\!SR}$',
 }
plot_colors = ['black','hotpink','darkgreen', 'darkorange', 'olive']
plot_markers = ['o','H','p', 'D','P']
plot_ms = [5, 6, 7, 5, 6]
...
plt.tight_layout()
plt.savefig("FigF15c_rmse_f1.pdf")


# =========================================================
# PLOT 2: F2
# =========================================================
#plot2_cols = ['Param_f2','SINDy_f2_ku0', 'Poly_f2',  'SINDy_f2']
plot2_cols = ['Param_f2','SINDy_f2_sym', 'Poly_f2',  'SINDy_f2', 'SINDy_f2_sym_SR']
...
label_map_f2 = {
    ...
    'Poly_f2': 'Poly-CC',
    'SINDy_f2': 'SINDy-CC',
    #'SINDy_f2_ku0': 'SINDy-CC ku0',
    'SINDy_f2_sym': r'SINDy-CC$_{+sym}$',
    'SINDy_f2_sym_SR': r'SINDy-CC$_{+sym+post\!\!-\!\!SR}$',
}
...
plt.tight_layout()
plt.savefig("FigF15d_rmse_f2.pdf")
plt.show()
