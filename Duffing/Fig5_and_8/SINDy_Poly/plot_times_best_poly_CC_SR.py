...
col_names = [
    "noise_perc_th", "noise_perc", "SNR_dB", "SINDy","SINDy_ku0", "SINDy_sym", "SINDy_sym_SR","Poly-CC","Parametric"
]
...
plot1_cols = ['Parametric','SINDy_sym','SINDy_sym_SR','Poly-CC','SINDy','SINDy_ku0']
label_map = {
    ...
    'SINDy_ku0': 'SINDy',
    'Poly-CC':'Poly-CC',
    'SINDy_sym':r'SINDy-CC$_{+sym}$',
    'SINDy_sym_SR':r'SINDy-CC$_{+sym+post\!\!-\!\!SR}$',
    'Parametric': 'Parametric',
}
#plot_colors = ['black','darkred','blue', 'darkgreen', 'darkorange','gray' ]
#plot_markers = ['o', '^','s', 'D', 'p', '*']
#plot_ms = [5, 6, 5, 5, 6,7]  # List of marker sizes
plot_colors = ['black','hotpink','olive','darkgreen', 'darkorange' ,'gray']
plot_markers = ['o','H', 'P', 'p', 'D','*']
plot_ms = [5, 6, 6, 6, 5, 7]  # List of marker sizes
...
ax_bottom.legend(ordered_handles, ordered_labels,fontsize=14,loc='lower left',labelspacing=0.2,frameon=False,handletextpad=0.1) #,markerfirst=False
...
ax_bottom.text(0.9, 0.98, '(b)', transform=ax_bottom.transAxes, fontsize=20, verticalalignment='top')



plt.tight_layout()
plt.savefig("Fig8b_time_results.pdf")
plt.show()
