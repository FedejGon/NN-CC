...
plot_colors = ['black', 'darkred', 'darkslateblue']
plot_markers = ['o', 's', 'H']
plot_ms = [5, 5, 6]
...
ax_bottom.set_ylabel('RMSE [x(t)]', fontsize=fontsize)
ax_bottom.axhline(y=20.0, color='red', linestyle='--')
ax_bottom.legend(labelspacing=0.15,fontsize=fontsize)
