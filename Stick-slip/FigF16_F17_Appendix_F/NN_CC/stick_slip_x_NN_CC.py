...
#SNR_dB_list = list(np.linspace(8, 1, 8 ))  # ∞, 20, 17.5, ..., -5
...
#            print("Warning:")
#            print("NN-CC_nosym+post-SR finished integration before maximum simulation time")
...
#                       header="noise_th noise noise_db rmse_x_NN_nosym rmse_x_dot_NN_nosym rmse_x_NN rmse_x_dot_NN rmse_x_NN_SR rmse_x_dot_NN_SR" if not file_exists else '',
