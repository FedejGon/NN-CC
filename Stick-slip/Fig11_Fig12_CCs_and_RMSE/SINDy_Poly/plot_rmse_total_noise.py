...
filename = 'rmse_noise_x_xdot.txt'

fontsize = 16

#col_names = [
#    "noise_perc_th", "noise_perc", "SNR_dB", "NN-CCx","NN-CCv", "SINDy-CCx","SINDy-CCv",
#    "LS-CCx","LS-CCv", "NN-CC extrapx","NN-CC extrapv","NN-CC-SRx","NN-CC-SRv", "SRx","SRv","Parametricx","Parametricv"
#]
col_names = [
    "noise_perc_th", "noise_perc", "SNR_dB", "SINDy", "vSINDy","SINDy_ku0", "vSINDy_ku0","Poly-CC","vPoly-CC","Parametric","vParametric"
]
#se_db 1pos_2vel  NN12  Sindy12 LS12 NN_retrain12 NN_SR12 SR12 Parametric12

df = pd.read_csv(filename, skiprows=7, delim_whitespace=True, header=None, names=col_names)
...
#plot1_cols = ['SINDy-CCx','LS-CCx','NN-CC-SRx','SRx','Parametricx'] #'NN-CCx'
#plot1_cols = ['Parametricx','NN-CC-SRx','SRx','LS-CCx','SINDy-CCx']#,'SINDy']
plot1_cols = ['SINDy_ku0', 'Poly-CC', 'SINDy', 'Parametric']
label_map = {
...
plot_colors = ['gray', 'darkgreen', 'darkorange', 'black']
plot_markers = ['*', 'D', 'p', 'o']
plot_ms = [7, 5, 5, 5]  # List of marker sizes
...
#label_map = {
#    #'NN_f1': 'Neural Network F1',
#    'NN-CC-SRx': 'NN-CC(sym.+SR)',
#    'SINDy-CCx': 'SINDy-CC',
#    'LS-CCx': 'Poly-CC',
#    'Parametricx': 'Parametric-CC',
#    'SRx': 'SR'
#    }
#plot_colors = ['black','blue','darkred', 'darkgreen', 'darkorange']#,'gray' ]
#plot_markers = ['o', 's', '^', 'D', 'p']#, '*']
#plot_ms = [5, 5, 6, 5, 6]#,7]  # List of marker sizes
...
for col, color, marker, ms in zip(plot1_cols, plot_colors, plot_markers, plot_ms):
    ax_bottom.plot(x_bottom, grouped[col], marker=marker, markersize=ms, color=color, label=label_map[col],ls='-',linewidth=1)
...
#ax_bottom.legend(labelspacing=0.15,loc='lower right',fontsize=fontsize)
...
plt.tight_layout()
plt.savefig("Fig12b_rmse_total_noise.pdf")
plt.show()
