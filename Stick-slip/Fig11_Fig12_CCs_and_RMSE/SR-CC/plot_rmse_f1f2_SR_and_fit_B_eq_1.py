...
ax_bottom.text(0.02, 0.98, '(e)', transform=ax_bottom.transAxes, fontsize=20, verticalalignment='top')
...
plt.tight_layout()
plt.savefig("Fig11e_rmse_f1.pdf")
...
ax_bottom.text(0.02, 0.98, '(f)', transform=ax_bottom.transAxes, fontsize=20, verticalalignment='top')
...
plt.tight_layout()
plt.savefig("Fig11f_rmse_f2.pdf")
plt.show()
