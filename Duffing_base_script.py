...
#    y = predicted_lin_F1_data + bias_correction + correction_extra
    ...
    rmse_values = {
        ...
        "SR_f1": 1e6, #rmse(predicted_F1_theor, predicted_F1_SR),
        "SR_f2": 1e6, #rmse(predicted_F2_theor, predicted_F2_SR),
    }
...
#                time_chaos_x_parametric_list.append(t_val[i])
        ...
        with open(file_path, 'a') as f:
            np.savetxt(f, time_matrix_append,
                       ...
                       header="nois_th nois nois_db  NN_nosym NN+sym NN+sym+SR  Sindy Sindy_ku0  Poly  SR  Parametric" if not file_exists else '',
     ...
     #   print("LS results")
        ...
        with open(file_path, 'a') as f:
            np.savetxt(f, rmse_matrix_append,
                       header="noise_th noise noise_db rmse_x_NN_nosym rmse_x_dot_NN_nosym rmse_x_NN rmse_x_dot_NN rmse_x_NN_SR rmse_x_dot_NN_SR rmse_x_Sindy rmse_x_dot_Sindy rmse_x_poly rmse_x_dot_poly" if not file_exists else '',
    ...
    with open(file_path, 'a') as f:
        np.savetxt(f, rmse_matrix,
                   header="noise_th noise_meas noise_db rmse_x_NN_nosym rmse_x_dot_NN_nosym rmse_x_NN rmse_x_dot_NN rmse_x_NN_SR rmse_x_dot_NN_SR rmse_x_Sindy rmse_x_dot_Sindy rmse_x_LS rmse_x_dot_LS" if not file_exists else '',
                   fmt="%.8f", delimiter=" ", comments='')
